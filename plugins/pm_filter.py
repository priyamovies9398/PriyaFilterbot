...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton(text="⚡ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://t.me/PriyaMovis')
        ]
    )
...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('𝐓𝐇𝐈𝐒 𝐌𝐎𝐕𝐈𝐄 𝐈𝐒 𝐍𝐎𝐓 𝐘𝐄𝐓 𝐑𝐄𝐋𝐄𝐀𝐒𝐄𝐃 𝐎𝐑 𝐀𝐃𝐃𝐄𝐃 𝐓𝐎 𝐃𝐀𝐓𝐀𝐁𝐀𝐒𝐄 IF U WANT THIS MOVIE CONTACT @priyassbot HE UPLOAD IT.💌')
    ...
    if query.data == "close_data":
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if (st.status == enums.ChatMemberStatus.OWNER) or (str(userid) in ADMINS):
                ...
                await query.answer("MAWA Don't Touch Others Property 😁", show_alert=True)
